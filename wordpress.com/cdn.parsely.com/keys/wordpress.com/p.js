(function() {
    ...
    window.PARSELY.flavor = "conversions-engagedtime-slots";
    ...
    window.PARSELY.__template_apikey = "wordpress.com";
...
/*! parsely-js-api - v2.1.0 - 2023-06-05
...
window.PARSELY = window.PARSELY || {},
    ...
    function() {
        ...
        function i(e, t) {
            var o, r, u, l, d, f = a,
                p = t[e];
            switch (p && "object" === _typeof(p) && "function" == typeof p.toJSON && (p = p.toJSON(e)), "function" == typeof c && (p = c.call(t, e, p)), _typeof(p)) {
                case "string":
                    return n(p);
                case "number":
                ...
                case "object":
                    if (!p) return "null";
                    if (a += s, d = [], "[object Array]" === Object.prototype.toString.apply(p)) {
                        for (l = p.length, o = 0; o < l; o += 1) d[o] = i(o, p) || "null";
                        return u = 0 === d.length ? "[]" : a ? "[\n" + a + d.join(",\n" + a) + "\n" + f + "]" : "[" + d.join(",") + "]", a = f, u
                    }
                    if (c && "object" === _typeof(c))
                        for (l = c.length, o = 0; o < l; o += 1) "string" == typeof c[o] && (u = i(r = c[o], p)) && d.push(n(r) + (a ? ": " : ":") + u);
                    else
                        for (r in p) Object.prototype.hasOwnProperty.call(p, r) && (u = i(r, p)) && d.push(n(r) + (a ? ": " : ":") + u);
                    return u = 0 === d.length ? "{}" : a ? "{\n" + a + d.join(",\n" + a) + "\n" + f + "}" : "{" + d.join(",") + "}", a = f, u
            }
        }
        window.PARSELY || (window.PARSELY = {});
        ...
        "function" != typeof JSON.stringify && (u = {
            ...
            if (c = t, t && "function" != typeof t && ("object" !== _typeof(t) || "number" != typeof t.length)) throw new Error("JSON.stringify");
            return i("", {
                "": e
            })
            ...
            return function(i, o) {
                ...
                try {
                    for (;;) {
                        if (!(a = l.exec(i))) break;
                        a[1] ? c[a[1]][t]() : a[2] ? (r = +a[2], u[t]()) : (r = e(a[3]), s[t]()), i = i.slice(a[0].length)
                    }
                } catch (d) {
                    t = d
                }
    ...
    function(e, t) {
        ...
        function o(e, t, n, i) {
            if (m.acceptData(e)) {
                var o, r, a = m.expando,
                    ...
                    u = s ? m.cache : e,
                    l = s ? e[a] : e[a] && a;
                if (l && u[l] && (i || u[l].data) || n !== undefined || "string" != typeof t) return l || (l = s ? e[a] = c.pop() || m.guid++ : a), u[l] || (u[l] = s ? {} : {
                    "toJSON": m.noop
                }), "object" !== _typeof(t) && "function" != typeof t || (i ? u[l] = m.extend(u[l], t) : u[l].data = m.extend(u[l].data, t)), r = u[l], i || (r.data || (r.data = {}), r = r.data), n !== undefined && (r[m.camelCase(t)] = n), "string" == typeof t ? null == (o = r[t]) && (o = r[m.camelCase(t)]) : o = r, o
            }
        }
        ...
        var c = [],
            ...
            g = f.hasOwnProperty,
            h = {},
            v = "1.11.1 -deprecated,-css,-css/addGetHookIf,-css/curCSS,-css/defaultDisplay,-css/hiddenVisibleSelectors,-css/support,-css/swap,-css/var/cssExpand,-css/var/isHidden,-css/var/rmargin,-css/var/rnumnonpx,-effects,-effects/Tween,-effects/animatedSelector,-effects/support,-dimensions,-offset,-ajax,-ajax/jsonp,-ajax/load,-ajax/parseJSON,-ajax/parseXML,-ajax/script,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl",
            m = function D(e, t) {
        ...
        m.fn = m.prototype = {
            ...
            var e, t, n, i, o, r, a = arguments[0] || {},
                ...
                u = arguments.length,
                c = !1;
            for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" === _typeof(a) || m.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
                if (null != (o = arguments[s]))
                    for (i in o) e = a[i], a !== (n = o[i]) && (c && n && (m.isPlainObject(n) || (t = m.isArray(n))) ? (t ? (t = !1, r = e && m.isArray(e) ? e : []) : r = e && m.isPlainObject(e) ? e : {}, a[i] = m.extend(c, r, n)) : n !== undefined && (a[i] = n));
            return a
        }, m.extend({
            ...
            "makeArray": function(e, t) {
                var i = t || [];
                return null != e && (n(Object(e)) ? m.merge(i, "string" == typeof e ? [e] : e) : d.call(i, e)), i
            },
            "guid": 1,
            "now": function() {
                return +new Date
        ...
        (m.fn.init = function(e, t) {
            ...
            if (!e) return this;
            if ("string" == typeof e) {
                if ((n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : x.exec(e)) && (n[1] || !t)) {
                    if (n[1]) {
                        if (t = t instanceof m ? t[0] : t, m.merge(this, m.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : k, !0)), w.test(n[1]) && m.isPlainObject(t))
                            for (n in t) m.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                        return this
                    }
                    return (i = k.getElementById(n[2])) && i.parentNode && (this.length = 1, this[0] = i), this.context = k, this.selector = e, this
                }
            } else {
                if (e.nodeType) return this.context = this[0] = e, this.length = 1, this;
                if (m.isFunction(e)) return "undefined" != typeof E.ready ? E.ready(e) : e(m)
            }
            return e.selector !== undefined && (this.selector = e.selector, this.context = e.context), m.makeArray(e, this)
        }).prototype = m.fn, E = m(k);
        var P, A = /\S+/g,
            L = "undefined" == typeof undefined ? "undefined" : _typeof(undefined);
        for (P in m(h)) break;
        h.ownLast = "0" !== P, m.acceptData = function(e) {
        ...
        ! function() {
            ...
            for (t in {
                    ...
                    "change": !0,
                    "focusin": !0
                }) n = "on" + t, (h[t + "Bubbles"] = n in e) || (i.setAttribute(n, "t"), h[t + "Bubbles"] = !1 === i.attributes[n].expando);
            i = null
        }();
        var C = /^key/,
        ...
        m.event = {
            ...
            "add": function(e, t, n, i, o) {
                var r, a, s, u, c, l, d, f, p, g, h, v = m._data(e);
                if (v) {
                    for (n.handler && (n = (u = n).handler, o = u.selector), n.guid || (n.guid = m.guid++), (a = v.events) || (a = v.events = {}), (l = v.handle) || ((l = v.handle = function(e) {
                            return _typeof(m) === L || e && m.event.triggered === e.type ? undefined : m.event.dispatch.apply(l.elem, arguments)
                        }).elem = e), s = (t = (t || "").match(A) || [""]).length; s--;) p = h = (r = T.exec(t[s]) || [])[1], g = (r[2] || "").split(".").sort(), p && (c = m.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = m.event.special[p] || {}, d = m.extend({
                        "type": p,
                        "origType": h,
                        "data": i,
                        "handler": n,
                        ...
                        "namespace": g.join(".")
                    }, u), (f = a[p]) || ((f = a[p] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(e, i, g, l) || (e.addEventListener ? e.addEventListener(p, l, !1) : e.attachEvent && e.attachEvent("on" + p, l))), c.add && (c.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, d) : f.push(d), m.event.global[p] = !0);
                    e = null
                }
            },
            "trigger": function(t, n, i, o) {
                var r, a, s, u, c, l, d, f = [i || k],
                    p = g.call(t, "type") ? t.type : t,
                    h = g.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = l = i = i || k, 3 !== i.nodeType && 8 !== i.nodeType && !O.test(p + m.event.triggered) && (p.indexOf(".") >= 0 && (p = (h = p.split(".")).shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[m.expando] ? t : new m.Event(p, "object" === _typeof(t) && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = undefined, t.target || (t.target = i), n = null == n ? [t] : m.makeArray(n, [t]), c = m.event.special[p] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
                    if (!o && !c.noBubble && !m.isWindow(i)) {
                        for (u = c.delegateType || p, O.test(u + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), l = s;
                        l === (i.ownerDocument || k) && f.push(l.defaultView || l.parentWindow || e)
                    }
                    for (d = 0;
                        (s = f[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? u : c.bindType || p, (r = (m._data(s, "events") || {})[t.type] && m._data(s, "handle")) && r.apply(s, n), (r = a && s[a]) && r.apply && m.acceptData(s) && (t.result = r.apply(s, n), !1 === t.result && t.preventDefault());
                    if (t.type = p, !o && !t.isDefaultPrevented() && (!c._default || !1 === c._default.apply(f.pop(), n)) && m.acceptData(i) && a && i[p] && !m.isWindow(i)) {
                        (l = i[a]) && (i[a] = null), m.event.triggered = p;
                        try {
                            i[p]()
                        } catch (v) {}
                        m.event.triggered = undefined, l && (i[a] = l)
                    }
                    return t.result
                }
            },
                ...
                if (s[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                    for (a = m.event.handlers.call(this, e, u), t = 0;
                        ...
                        for (e.currentTarget = o.elem, r = 0;
                            (i = o.handlers[r++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i, e.data = i.data, (n = ((m.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, s)) !== undefined && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
                ...
                if (s && u.nodeType && (!e.button || "click" !== e.type))
                    for (; u != this; u = u.parentNode || this)
                        if (1 === u.nodeType && (!0 !== u.disabled || "click" !== e.type)) {
                            for (o = [], r = 0; r < s; r++) o[n = (i = t[r]).selector + " "] === undefined && (o[n] = i.needsContext ? m(n, this).index(u) >= 0 : m.find(n, this, null, [u]).length), o[n] && o.push(i);
                            o.length && a.push({
                                "elem": u,
                                "handlers": o
                            })
            ...
            "fix": function(e) {
                ...
                var t, n, i, o = e.type,
                    r = e,
                    a = this.fixHooks[o];
                for (a || (this.fixHooks[o] = a = R.test(o) ? this.mouseHooks : C.test(o) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new m.Event(r), t = i.length; t--;) e[n = i[t]] = r[n];
            ...
            e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === undefined && !1 === e.returnValue ? r : a) : this.type = e, t && m.extend(this, t), this.timeStamp = e && e.timeStamp || m.now(), this[m.expando] = !0
        }, m.Event.prototype = {
        ...
        m.param = function(e, t) {
            ...
            if (t === undefined && (t = m.ajaxSettings && m.ajaxSettings.traditional), m.isArray(e) || e.jquery && !m.isPlainObject(e)) m.each(e, function() {
        ...
        return m.noConflict = function(t) {
            return e.$ === m && (e.$ = j), t && e.jQuery === m && (e.jQuery = I), m
        }, _typeof(t) === L && (e.jQuery = e.$ = m), m
    ...
    function(e, t) {
        ...
        var t = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function(e) {
            ...
            p = "frozen",
            g = "terminated",
            h = "object" === ("undefined" == typeof safari ? "undefined" : t(safari)) && safari.pushNotification,
            v = ["focus", "blur", "visibilitychange", "freeze", "resume", "pageshow", "onpageshow" in self ? "pagehide" : "unload"],
            m = function(e) {
            ...
            _ = function() {
                return document.visibilityState === f ? f : document.hasFocus() ? l : d
            };
        return new(function(e) {
            function t() {
                ...
                var e = r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this)),
                    i = _();
                return e._state = i, e._unsavedChanges = [], e._handleEvents = e._handleEvents.bind(e), v.forEach(function(t) {
                    return addEventListener(t, e._handleEvents, !0)
                }), h && addEventListener("beforeunload", function(t) {
            ...
            return o(t, s), i(t, [{
                ...
                "value": function(e) {
                    !this._unsavedChanges.indexOf(e) > -1 && (0 === this._unsavedChanges.length && addEventListener("beforeunload", m), this._unsavedChanges.push(e))
                }
            }, {
                "key": "removeUnsavedChanges",
                "value": function(e) {
                    var t = this._unsavedChanges.indexOf(e);
                    t > -1 && (this._unsavedChanges.splice(t, 1), 0 === this._unsavedChanges.length && removeEventListener("beforeunload", m))
                }
            }, {
                ...
                "value": function(e, t) {
                    if (t !== this._state)
                        for (var n = function(e, t) {
                            ...
                            var o = n[i],
                                r = n[i + 1];
                            this._state = r, this.dispatchEvent(new c("statechange", {
                                "oldState": o,
                                "newState": r,
                                "originalEvent": e
                            }))
                ...
                "key": "_handleEvents",
                "value": function(e) {
                    switch (h && clearTimeout(this._safariBeforeUnloadTimeout), e.type) {
                        case "pageshow":
                        case "resume":
                        ...
                        case "visibilitychange":
                            this._state !== p && this._state !== g && this._dispatchChangesIfNeeded(e, _());
                            break;
                        case "freeze":
        ...
        var e = this.PARSELY,
            ...
            a = n.extend({
                ...
                "getSession": function(n) {
                    ...
                    if (void 0 === s) {
                        var u, c;
                        !1 === a ? (u = 1, c = 0) : (a.session_count++, u = a.session_count, c = a.last_session_ts);
                        var l = new Date;
                        s = {
                            "sid": u,
                            "surl": t.getEventUrl(),
        ...
        if (r.slots = r.slots || {}, document.querySelector) {
            ...
            a.objAddEventListener(document.body, "click", function(a) {
                ...
                if (!n(u.getAttribute("href"))) {
                    ...
                    s.setJSON("_parsely_slot_click", d)
                }
            }, !0)
    ...
    function() {
        ...
        if ("boolean" != typeof e.enableHeartbeats || e.enableHeartbeats) {
            ...
            }) : setInterval(c, 1e3 * s), e.engagedTime.getParams = function() {
                return {
                    "minActiveTimeout": 1,
                    "maxActiveTimeout": 60,
                    "activeTimeout": s
    ...
    function() {
        ...
        PARSELY.Pixel = n.extend({
                ...
                if (void 0 !== n && (this.third_party_analytics_is_blocked = n[t.flagAttribute]), "undefined" == typeof this.third_party_analytics_is_blocked && "undefined" == typeof this.third_party_analytics_checked) {
                    ...
                    var i = this,
                        o = function(e) {
                            ...
                            var n = {};
                            n[t.flagAttribute] = e, c.setJSON(t.name, n, {
            ...
            "requestFetch": function(n, i) {
                return o.log("fetching endpoint: " + this.remoteEndpoint), "undefined" != typeof l.fetch && (n.u = i, fetch(this.buildEventRequestUrl(n), {
                    "method": "GET",
                    "mode": "no-cors",
                    "keepalive": !0
                })["catch"](function(e) {
            ...
            "beacon": function(n, o, c) {
                ...
                var h;
                for (var v in this.correlationIds) void 0 !== (h = this.generateEventCorrelationId(v, v === p.action)) && (p[this.correlationIds[v]] = h);
                p.data = i.stringify(p.data), !0 !== o && (PARSELY.lastRequest = p), r.uuid = g.id, this.shouldGenerateVisitorID(g.id) && this.generateVisitorID(), !0 === c && (e.util.isFirefox() || e.util.isSafari()) && (c = !1), this.remoteEndpoint = a.pixel + this.selectEndpoint();
                var m = !1;
                !0 === c && (m = this.requestFetch(p, r.uuid)), !1 === m && this.sendEvent(p, r.uuid)
            }
        })
    }(),
    function() {
        ...
        PARSELY.Beacon = i.extend({
            ...
            "trackPageView": function(i, s) {
                ...
                c && (r.expire("_parsely_slot_click"), n.log("Valid slot click found"), u.sl_xp = c.xpath, u.sl_x = c.x, u.sl_y = c.y, u.sl_h = c.href, c.url !== u.urlref && n.log("urlref overridden by slot data as " + c.url), u.urlref = c.url), i && t.extend(u, i), this.pixel.beacon(u, s)
            },
