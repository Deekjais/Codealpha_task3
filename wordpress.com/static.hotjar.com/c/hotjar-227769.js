window.hjSiteSettings = window.hjSiteSettings || {
    "site_id": 227769,
    "rec_value": 0.0009612023767913316,
    ...
    "features": ["survey.embeddable_widget", "heatmap.continuous.manual_retaker", "survey.type_button", "feedback.widget_telemetry", "survey.image_question", "ask.use_insights_internal_api", "feedback.widgetV2", "error_reporting", "ask.separate_service", "settings.billing_v2", "client_script.compression.pc", "feedback.embeddable_widget"],
    ...
    227: function(e, t, r) {
        ...
        var l, f = function() {
            ...
            m = function(e, t) {
                ...
                return "lab" === t && (r = d.browser.inLab), "field" === t && (r = h.isFieldMedtricsEnabled), e ? r && e.flush : r
            },
            w = function(e) {
                var t = !1,
                ...
                start: function() {
                    try {
                        ...
                        return h.genericTags = {
                            site_id: n
                        }, h.isDebugEnabled = i.has(s.flag) && Math.random() <= s.sampling, h.isMetricsEnabled = Math.random() <= u.sampling, h.isFieldMedtricsEnabled = h.isMetricsEnabled && Math.random() <= c.sampling, l = new o(w, d.buffer.bufferSize, d.buffer.flushInterval), e
                    } catch (e) {
                ...
                timeEnd: function(e, t) {
                    ...
                    try {
                        ...
                        var s, u = v(e, r),
                            ...
                            d = u.total;
                        if (n) {
                            var h, b = null !== (h = n.total) && void 0 !== h ? h : n.start && o - n.start;
                            s = b ? (d || 0) + b : d;
                            var w = n.flush ? void 0 : {
                                total: s
                            };
                            g(e, f, w)
        ...
        window.hjBootstrap = window.hjBootstrap || function(e, t, r) {
            ...
            f.async = 1, f.src = hj.scriptDomain + t, f.charset = "utf-8", l.appendChild(f), u.revision = "646b0dc", window.hjBootstrap = u
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.be28aa100b6c5e9c734a.js", "227769"), hj.metrics.timeEnd("resource-blocking-time", {
            tag: {
                resource: "hotjar-js"
            },
            incr: {
            ...
            SURVEY_V2: {
                js: "survey-v2.ffaef7708d826d48f496.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.74e2b1d66a9c249aee1c.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.ea4445700245be42d8f7.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.a5acb3dc9f289139abf4.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.0cdd92fc5c5fe9bed8e4.js"
            },
            NOTIFICATION: {
                js: "notification.5219d46bb1e1920f45d1.js"
            },
            INCOMING_FEEDBACK: {
                js: "incoming-feedback.2429f7ee11d2f7907e8f.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.bab37197264a11dc3d62.js"
            },
            SENTRY: {
                js: "sentry.4015ae92d08d2d80dade.js"
            },
            BROWSER_PERF: {
                js: "browser-perf.1c7ecd2be12644b9e658.js"
            }
        }
    }
});